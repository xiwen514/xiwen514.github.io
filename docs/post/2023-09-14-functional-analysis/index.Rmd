...
#### Example codes in R
clusterProfiler perform over-representation analysis on GO terms associated with our list of significant genes. The tool takes as input a significant gene list and a background gene list and performs statistical enrichment analysis using hypergeometric testing.
...
gsva : 提供count data, meta info , 不需要提前差异分析
enrichKEGG；gsva; gseKEGG;
